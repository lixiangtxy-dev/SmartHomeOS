...
// 2. 增加下面这 5 个宏定义，禁用标准库函数
#define LFS_NO_MALLOC   // 禁用 malloc (我们等下手动分配内存)
#define LFS_NO_ASSERT   // 禁用 assert
#define LFS_NO_DEBUG    // 禁用 printf 调试信息
#define LFS_NO_WARN     // 禁用 printf 警告信息
#define LFS_NO_ERROR    // 禁用 printf 报错信息
